class BooksController < ApplicationController
  ...
  def book_params
    params.require(:book).permit(:fullTitle, :title, :shortTitle,:className,  :year, :contributors, :publisher, :language, :pages, :description, :amazonLink, :height, :width, :photoLink)
  end
